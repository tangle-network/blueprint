...
const TANGLE_RELEASE_MAC: &str = "https://github.com/tangle-network/tangle/releases/download/v1.4.2/tangle-testnet-manual-seal-testnet-darwin-amd64";
const TANGLE_RELEASE_LINUX: &str = "https://github.com/tangle-network/tangle/releases/download/v1.4.2/tangle-testnet-manual-seal-testnet-linux-amd64";
