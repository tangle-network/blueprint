...
const TANGLE_RELEASE_MAC: &str = "https://github.com/tangle-network/tangle/releases/download/7a06b61/tangle-testnet-manual-seal-darwin-amd64";
const TANGLE_RELEASE_LINUX: &str = "https://github.com/tangle-network/tangle/releases/download/7a06b61/tangle-testnet-manual-seal-linux-amd64";
