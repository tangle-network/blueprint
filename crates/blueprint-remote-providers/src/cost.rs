...
impl CostEstimator {
    pub fn new() -> Self {
        ...
        providers.insert(CloudProvider::AWS, ProviderCost {
            cpu_hour: 0.0464,
        ...
        // GCP pricing
        providers.insert(CloudProvider::GCP, ProviderCost {
            cpu_hour: 0.0475,
        ...
        // Azure pricing
        providers.insert(CloudProvider::Azure, ProviderCost {
            cpu_hour: 0.048,
        ...
        providers.insert(CloudProvider::DigitalOcean, ProviderCost {
            cpu_hour: 0.03,
        ...
        // Generic/self-hosted
        providers.insert(CloudProvider::Generic, ProviderCost {
            cpu_hour: 0.001,
    ...
    pub fn estimate(&self, 
        ...
        let provider_cost = self.providers.get(provider)
