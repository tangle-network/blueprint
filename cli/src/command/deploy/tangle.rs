...
pub async fn deploy_tangle(
    ...
    let bob_alloy_key = bob_ecdsa_signer
        .alloy_key()
        .map_err(|e| color_eyre::Report::msg(format!("Failed to get Bob's Alloy key: {}", e)))?;
    ...
    println!(
        "\n{}",
        style(
            "If your blueprint was just generated from the template, you can follow the demo below:"
        )
        .cyan()
        .bold()
    );
