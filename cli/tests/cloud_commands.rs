...
mod cloud_tests {
    ...
    fn test_cloud_help() {
        let output = Command::new("cargo")
            .args(&["run", "-p", "cargo-tangle", "--", "tangle", "cloud", "--help"])
            .output()
        ...
        assert!(stdout.contains("Cloud deployment") || stdout.contains("configure"),
    ...
    fn test_cloud_configure_help() {
        let output = Command::new("cargo")
            .args(&["run", "-p", "cargo-tangle", "--", "tangle", "cloud", "configure", "--help"])
            .output()
            .expect("Failed to execute command");
    ...
    fn test_cloud_estimate_help() {
        let output = Command::new("cargo")
            .args(&["run", "-p", "cargo-tangle", "--", "tangle", "cloud", "estimate", "--help"])
            .output()
            .expect("Failed to execute command");
        ...
        assert!(
            stdout.contains("cost") || stdout.contains("compare") ||
            stderr.contains("cost") || stderr.contains("compare"),
    ...
    fn test_invalid_provider() {
        let output = Command::new("cargo")
            .args(&["run", "-p", "cargo-tangle", "--", "tangle", "cloud", "configure", "invalid"])
            .output()
            .expect("Failed to execute command");
    ...
    fn test_cloud_status_empty() {
        ...
        let output = Command::new("cargo")
            .args(&["run", "-p", "cargo-tangle", "--", "tangle", "cloud", "status", "--help"])
            .output()
            .expect("Failed to execute command");
