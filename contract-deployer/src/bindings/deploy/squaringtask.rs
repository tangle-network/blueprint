...
pub mod TaskManager {
    ...
    impl<T, P, N> ::core::fmt::Debug for TaskManagerInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("TaskManagerInstance")
                .field(&self.address)
                .finish()
        }
    }
...
pub mod SquaringTask {
        ...
        impl alloy_sol_types::SolEvent for AggregatorUpdated {
            ...
            const SIGNATURE_HASH: alloy_sol_types::private::B256 =
                alloy_sol_types::private::B256::new([
                    ...
                    253u8, 42u8, 132u8, 49u8, 197u8, 27u8, 73u8, 251u8, 230u8, 84u8, 195u8, 247u8,
                    181u8, 239u8, 25u8, 118u8, 62u8, 44u8, 205u8, 136u8, 242u8,
                ]);
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolEvent for GeneratorUpdated {
            ...
            const SIGNATURE_HASH: alloy_sol_types::private::B256 =
                alloy_sol_types::private::B256::new([
                    13u8, 223u8, 171u8, 138u8, 99u8, 93u8, 113u8, 241u8, 93u8, 114u8, 226u8, 210u8,
                    223u8, 245u8, 93u8, 50u8, 17u8, 157u8, 19u8, 39u8, 13u8, 46u8, 164u8, 195u8,
                    220u8, 0u8, 67u8, 182u8, 108u8, 44u8, 71u8, 107u8,
                ]);
            const ANONYMOUS: bool = false;
            #[allow(unused_variables)]
            #[inline]
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolEvent for NewTaskCreated {
            ...
            const SIGNATURE_HASH: alloy_sol_types::private::B256 =
                alloy_sol_types::private::B256::new([
                    186u8, 55u8, 131u8, 43u8, 221u8, 33u8, 116u8, 43u8, 134u8, 166u8, 51u8, 4u8,
                    59u8, 146u8, 58u8, 154u8, 169u8, 120u8, 241u8, 207u8, 178u8, 178u8, 116u8,
                    198u8, 102u8, 30u8, 181u8, 115u8, 207u8, 9u8, 43u8, 240u8,
                ]);
            const ANONYMOUS: bool = false;
            #[allow(unused_variables)]
            #[inline]
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolEvent for SquaringTaskCompleted {
            ...
            const SIGNATURE_HASH: alloy_sol_types::private::B256 =
                alloy_sol_types::private::B256::new([
                    167u8, 167u8, 7u8, 221u8, 127u8, 76u8, 160u8, 15u8, 225u8, 175u8, 205u8, 52u8,
                    223u8, 126u8, 187u8, 108u8, 71u8, 242u8, 56u8, 128u8, 195u8, 77u8, 37u8, 76u8,
                    195u8, 18u8, 229u8, 196u8, 30u8, 57u8, 116u8, 197u8,
                ]);
            const ANONYMOUS: bool = false;
            #[allow(unused_variables)]
            #[inline]
    ...
    pub struct TaskResponded {
        ...
        pub taskResponseMetadata:
            <TaskManager::TaskResponseMetadata as alloy::sol_types::SolType>::RustType,
    }
    #[allow(
        non_camel_case_types,
        non_snake_case,
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolEvent for TaskResponded {
            type DataTuple<'a> = (TaskManager::TaskResponse, TaskManager::TaskResponseMetadata);
            type DataToken<'a> = <Self::DataTuple<'a> as alloy_sol_types::SolType>::Token<'a>;
            type TopicList = (alloy_sol_types::sol_data::FixedBytes<32>,);
    ...
    const _: () = {
        use alloy::sol_types as alloy_sol_types;
        {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<__TaskManager_initCall> for UnderlyingRustTuple<'_> {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<UnderlyingRustTuple<'_>> for __TaskManager_initCall {
                fn from(tuple: UnderlyingRustTuple<'_>) -> Self {
                    Self {
                        _aggregator: tuple.0,
                        _generator: tuple.1,
        ...
        }
        {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<__TaskManager_initReturn> for UnderlyingRustTuple<'_> {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<UnderlyingRustTuple<'_>> for __TaskManager_initReturn {
                fn from(tuple: UnderlyingRustTuple<'_>) -> Self {
                    Self {}
                }
            }
    ...
    const _: () = {
        use alloy::sol_types as alloy_sol_types;
        {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<createSquaringTaskCall> for UnderlyingRustTuple<'_> {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<UnderlyingRustTuple<'_>> for createSquaringTaskCall {
                fn from(tuple: UnderlyingRustTuple<'_>) -> Self {
                    Self {
                        number: tuple.0,
                        quorumThresholdPercentage: tuple.1,
        ...
        }
        {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<createSquaringTaskReturn> for UnderlyingRustTuple<'_> {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<UnderlyingRustTuple<'_>> for createSquaringTaskReturn {
                fn from(tuple: UnderlyingRustTuple<'_>) -> Self {
                    Self {}
                }
            }
    ...
    const _: () = {
        use alloy::sol_types as alloy_sol_types;
        {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<respondToSquaringTaskCall> for UnderlyingRustTuple<'_> {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<UnderlyingRustTuple<'_>> for respondToSquaringTaskCall {
                fn from(tuple: UnderlyingRustTuple<'_>) -> Self {
                    Self {
                        task: tuple.0,
        ...
        }
        {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<respondToSquaringTaskReturn> for UnderlyingRustTuple<'_> {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<UnderlyingRustTuple<'_>> for respondToSquaringTaskReturn {
                fn from(tuple: UnderlyingRustTuple<'_>) -> Self {
                    Self {}
                }
            }
    ...
    impl alloy_sol_types::SolInterface for SquaringTaskCalls {
        ...
        fn selector(&self) -> [u8; 4] {
            match self {
                ...
                Self::setAggregator(_) => <setAggregatorCall as alloy_sol_types::SolCall>::SELECTOR,
                Self::setGenerator(_) => <setGeneratorCall as alloy_sol_types::SolCall>::SELECTOR,
        ...
        fn abi_encode_raw(&self, out: &mut alloy_sol_types::private::Vec<u8>) {
            match self {
                ...
                Self::__TaskManager_init(inner) => {
                    <__TaskManager_initCall as alloy_sol_types::SolCall>::abi_encode_raw(inner, out)
                }
                Self::aggregator(inner) => {
                ...
                Self::createSquaringTask(inner) => {
                    <createSquaringTaskCall as alloy_sol_types::SolCall>::abi_encode_raw(inner, out)
                }
                Self::delegation(inner) => {
                ...
                Self::setAggregator(inner) => {
                    <setAggregatorCall as alloy_sol_types::SolCall>::abi_encode_raw(inner, out)
                }
                Self::setGenerator(inner) => {
                    <setGeneratorCall as alloy_sol_types::SolCall>::abi_encode_raw(inner, out)
                }
                Self::setStaleStakesForbidden(inner) => {
    ...
    impl alloy_sol_types::SolInterface for SquaringTaskErrors {
        ...
        fn selector(&self) -> [u8; 4] {
            match self {
                Self::AlreadySet(_) => <AlreadySet as alloy_sol_types::SolError>::SELECTOR,
            ...
            static DECODE_SHIMS: &[fn(
                ...
                },
                {
                    fn ZeroValue(
                        ...
                        <ZeroValue as alloy_sol_types::SolError>::abi_decode_raw(data, validate)
                ...
                },
                {
                    fn AlreadySet(
                        ...
                        <AlreadySet as alloy_sol_types::SolError>::abi_decode_raw(data, validate)
        ...
        fn abi_encoded_size(&self) -> usize {
            match self {
                ...
                Self::IncorrectSquareResult(inner) => {
                    <IncorrectSquareResult as alloy_sol_types::SolError>::abi_encoded_size(inner)
                }
                ...
                Self::NoOngoingDeployment(inner) => {
                    <NoOngoingDeployment as alloy_sol_types::SolError>::abi_encoded_size(inner)
                }
        ...
        fn abi_encode_raw(&self, out: &mut alloy_sol_types::private::Vec<u8>) {
            match self {
                ...
                Self::IncorrectSquareResult(inner) => {
                    <IncorrectSquareResult as alloy_sol_types::SolError>::abi_encode_raw(inner, out)
                }
                Self::InputArrayLengthMismatch(inner) => {
                ...
                Self::NoOngoingDeployment(inner) => {
                    <NoOngoingDeployment as alloy_sol_types::SolError>::abi_encode_raw(inner, out)
                }
                Self::NonSignerPubkeysNotSorted(inner) => {
    ...
    impl SquaringTaskEvents {
        ...
        pub const SELECTORS: &'static [[u8; 32usize]] = &[
            [
                13u8, 223u8, 171u8, 138u8, 99u8, 93u8, 113u8, 241u8, 93u8, 114u8, 226u8, 210u8,
                223u8, 245u8, 93u8, 50u8, 17u8, 157u8, 19u8, 39u8, 13u8, 46u8, 164u8, 195u8, 220u8,
                0u8, 67u8, 182u8, 108u8, 44u8, 71u8, 107u8,
            ],
            [
                64u8, 228u8, 237u8, 136u8, 10u8, 41u8, 224u8, 246u8, 221u8, 206u8, 48u8, 116u8,
            ...
            [
                137u8, 186u8, 171u8, 239u8, 125u8, 253u8, 6u8, 131u8, 192u8, 172u8, 22u8, 253u8,
                42u8, 132u8, 49u8, 197u8, 27u8, 73u8, 251u8, 230u8, 84u8, 195u8, 247u8, 181u8,
                239u8, 25u8, 118u8, 62u8, 44u8, 205u8, 136u8, 242u8,
            ],
            [
            ...
            [
                186u8, 55u8, 131u8, 43u8, 221u8, 33u8, 116u8, 43u8, 134u8, 166u8, 51u8, 4u8, 59u8,
                146u8, 58u8, 154u8, 169u8, 120u8, 241u8, 207u8, 178u8, 178u8, 116u8, 198u8, 102u8,
                30u8, 181u8, 115u8, 207u8, 9u8, 43u8, 240u8,
            ],
        ];
    }
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for SquaringTaskEvents {
        ...
        fn decode_raw_log(
            ...
            match topics.first().copied() {
                Some(<AggregatorUpdated as alloy_sol_types::SolEvent>::SIGNATURE_HASH) => {
                ...
                Some(<SquaringTaskCompleted as alloy_sol_types::SolEvent>::SIGNATURE_HASH) => {
    ...
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<SquaringTaskInstance<T, P, N>>>
    {
        SquaringTaskInstance::<T, P, N>::deploy(
            provider,
    ...
    >(
        ...
        SquaringTaskInstance::<T, P, N>::deploy_builder(
            provider,
            _registryCoordinator,
            _taskResponseWindowBlock,
        )
    ...
    impl<T, P, N> ::core::fmt::Debug for SquaringTaskInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("SquaringTaskInstance")
                .field(&self.address)
                .finish()
        }
    }
    ...
    > SquaringTaskInstance<T, P, N>
    {
        ...
        pub fn __TaskManager_init(
            ...
            self.call_builder(&__TaskManager_initCall {
                _aggregator,
                _generator,
                initialOwner,
            })
        ...
        pub fn createSquaringTask(
            ...
            self.call_builder(&createSquaringTaskCall {
                number,
        ...
        pub fn respondToSquaringTask(
            ...
            self.call_builder(&respondToSquaringTaskCall {
                task,
                taskResponse,
    ...
    > SquaringTaskInstance<T, P, N>
    {
        ...
        pub fn GeneratorUpdated_filter(&self) -> alloy_contract::Event<T, &P, GeneratorUpdated, N> {
