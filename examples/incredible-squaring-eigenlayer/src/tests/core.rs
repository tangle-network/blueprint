...
pub async fn deploy_core_contracts(
    ...
    let delegation_manager_impl = delegation_manager::DelegationManager::deploy(
        &wallet,
    ...
    let delegation_manager_init_data = delegation_manager::DelegationManager::initializeCall {
